...
Проект матрица в школе 21 на языке C++.
...
- Реализовать операции, описанные [тут](#операции-над-матрицами)
- Перегрузить операторы в соответствии с таблицой [тут](#перегрузка-следующих-операторов-частично-соответствующих-операциям-выше).
- Подготовить полное покрытие unit-тестами функций библиотеки c помощью библиотеки GTest
- Предусмотреть Makefile для сборки библиотеки и тестов (с целями all, clean, test, matrix.a)
...
### Перегрузка следующих операторов, частично соответствующих операциям выше
